...
const SubjectCard: FC<SubjectCardProps> = ({
    ...
    return (
        <View className="h-52 w-1/2 relative overflow-hidden p-2">
            <AnimatedButton className="size-full relative rounded-[30px] mb-2 overflow-hidden flex items-center justify-between">
                <ImageBackground
                    source={{
                        uri:
                            bgUri ||
                            "https://wallpapers.com/images/hd/english-2000-x-1261-wallpaper-niju8wupslurmn2i.jpg",
                    }}
                ...
                <Link href={href as any} asChild>
                    <AnimatedButton
                        activeOpacity={0.7}
                        className="w-10/12 h-12 items-center justify-center mb-2 rounded-full overflow-hidden border border-white/30"
                    >
                        <BlurView
                            intensity={40}
                            tint="dark"
                            className="size-full flex-row items-center justify-center gap-2"
                        >
